...
export default function HowWeWork({
  ...
  return (
    <section className="py-14 border-t border-bw-lightgray" aria-labelledby="services-process-title">
      ...
      <div className="mt-6 hidden grid-cols-4 gap-3 md:grid" role="tablist" aria-label={tabLabel}>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-2xl border border-bw-lightgray bg-white p-6 shadow-sm motion-safe:animate-in motion-safe:fade-in">
          ...
          <div className="mt-5 md:mt-0">
            <p className="text-xs uppercase tracking-[0.2em] text-bw-secondary">{activeLabel}</p>
