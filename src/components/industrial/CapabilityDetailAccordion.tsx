...
export default function CapabilityDetailAccordion({
  isOpen,
  title,
  destinationHref,
  destinationLabel,
  ...
  return (
    <div className={`grid transition-all duration-300 ${isOpen ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`} aria-hidden={!isOpen}>
